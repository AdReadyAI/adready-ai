/**
 * context.ts — DB-backed AgentContext loader for the Product Representation agent.
 *
 ...
 * transcript, OCR, visual/product/logo frames, product context) and validates
 * it with AgentContextSchema.
 */
